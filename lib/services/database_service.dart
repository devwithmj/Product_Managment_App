  ...
  Future<void> _onUpgrade(Database db, int oldVersion, int newVersion) async {
    ...
    if (oldVersion < 7) {
      try {
        ...
        // Add isAutoGenerated field
        if (!tableInfo.any((column) => column['name'] == 'isAutoGenerated')) {
          await db.execute(
            'ALTER TABLE ${AppConfig.productsTable} ADD COLUMN isAutoGenerated INTEGER DEFAULT 0',
          );
        }

        print('Successfully upgraded database to version 7');
      } catch (e) {
