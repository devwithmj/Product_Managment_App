...
class Product {
  ...
  bool
  isAutoGenerated; // Flag to mark products created automatically from CSV import
  DateTime createdAt;
  DateTime updatedAt;
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'barcode': barcode,
      'isAutoGenerated':
          isAutoGenerated ? 1 : 0, // Convert bool to int for SQLite
  ...
  factory Product.fromMap(Map<String, dynamic> map) {
    ...
    // Handle both bool and int for isAutoGenerated field
    bool isAutoGen;
    if (map['isAutoGenerated'] is bool) {
      isAutoGen = map['isAutoGenerated'];
    } else if (map['isAutoGenerated'] is int) {
      isAutoGen = map['isAutoGenerated'] == 1;
    } else {
      isAutoGen = false; // Default to false for existing products
    }
  ...
  String toString() {
    return 'Product(id: $id, nameEn: $nameEn, nameFa: $nameFa, brandEn: $brandEn, '
        ...
        'isAutoGenerated: $isAutoGenerated, labelOptions: $labelOptions)';
  }
}
